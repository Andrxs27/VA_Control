...
const VA_TRADUCCIONES = {
  es: {
    ...
    'rep_clientes_atendidos': 'Clientes Atendidos',
    'rep_ingresos_meses': 'Ingresos de los últimos 6 meses',
    'rep_tipo_entrega': 'Órdenes por tipo de entrega',
    'rep_ordenes_estado': 'Órdenes por estado',
    'rep_inventario_cat': 'Inventario por categoría (valor)',
    'rep_top_tecnicos': 'Top técnicos del período',
    'rep_top_clientes': 'Top clientes del período',
    'rep_stock_critico': 'Stock crítico',
    'rep_ordenes_periodo': 'Órdenes del período',
    'btn_filtrar': 'Filtrar',
    'btn_limpiar': 'Limpiar',
    'btn_excel': 'Excel',
  ...
  en: {
    ...
    'rep_clientes_atendidos': 'Clients Served',
    'rep_ingresos_meses': 'Revenue over the last 6 months',
    'rep_tipo_entrega': 'Orders by delivery type',
    'rep_ordenes_estado': 'Orders by status',
    'rep_inventario_cat': 'Inventory by category (value)',
    'rep_top_tecnicos': 'Top technicians of the period',
    'rep_top_clientes': 'Top clients of the period',
    'rep_stock_critico': 'Critical stock',
    'rep_ordenes_periodo': 'Orders of the period',
    'btn_filtrar': 'Filter',
    'btn_limpiar': 'Clear',
    'btn_excel': 'Excel',
    // Reportes - textos dinámicos
